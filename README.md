...
- [ ] Explain benefit(s) using `client-side routing`?
  > Answer:Routing between views are much faster. Makes for a better user focused app like twitter; allows endless stream of content.
- [ ] What does AJAX stand for?
  > Answer: Asynchronous JavaScript and XML.
- [ ] What are `controlled components` in React?
  > Answer: Data received through props passed down from it's container component.
